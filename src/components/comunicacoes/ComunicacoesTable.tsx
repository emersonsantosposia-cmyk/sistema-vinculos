...
export function ComunicacoesFilters({ comunicacoes }: Props) {
  ...
  return (
    <div className="mb-3 flex flex-wrap items-end gap-2">
      ...
      <p className="ml-auto self-center text-xs text-muted">
        {comunicacoes.length} registro{comunicacoes.length === 1 ? "" : "s"}
      </p>
    </div>
  );
}

export function ComunicacoesTable({ comunicacoes }: Props) {
